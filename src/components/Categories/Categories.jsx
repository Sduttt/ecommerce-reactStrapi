...
const Categories = () => {
  return (
    <div id="categories" className="flex flex-col md:flex-row gap-1 md:h-[80vh] m-2">{/* flex flex-col md:flex-row gap-1 m-2 */}
      <div className="flex flex-col flex-2 gap-1">
        <div className="gap-1 fex  relative overflow-hidden">
          <img src="https://images.pexels.com/photos/904616/pexels-photo-904616.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="category" className="w-[100%] h-36 md:h-[100%] object-cover" />
        ...
        <div className="gap-1 fex relative overflow-hidden">
          <img src="https://images.pexels.com/photos/2662180/pexels-photo-2662180.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="category" className="w-[100%] h-36 md:h-[100%] object-cover" />
      ...
      <div className="flex ">
        <div className="gap-1 fex relative overflow-hidden">
          <img src="https://images.pexels.com/photos/2846814/pexels-photo-2846814.jpeg" alt="category" className="w-[100vw] md:w-[100%] h-36 md:h-[100%] object-cover" />
      ...
      <div className="flex flex-col fex-2 gap-1">
        <div className="flex flex-col md:flex-row gap-1">
          <div className="gap-1 fex  relative overflow-hidden">
            <img src="https://images.pexels.com/photos/990432/pexels-photo-990432.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="category" className="w-[100%] h-36 md:h-[100%] object-cover" />
          ...
          <div className="gap-1 fex  relative overflow-hidden">
            <img src="https://images.pexels.com/photos/34592/pexels-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="category" className="w-[100%] h-36 md:h-[100%] object-cover" />
        ...
        <div className="fex  relative overflow-hidden">
          ...
          <img src="https://images.pexels.com/photos/1893264/pexels-photo-1893264.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="category" className="w-[100%] h-36 md:h-[100%] object-cover" />
